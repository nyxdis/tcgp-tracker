...
from .models import (
    PokemonSet, Pack, Card, UserCard, RarityProbability, Version, Rarity, UserProfile, FriendRequest
)
...
class SetAdmin(admin.ModelAdmin):
    ...
    def view_cards_link(self, obj):
        ...
        url = (
            reverse('admin:tracker_card_changelist') + f'?set__id__exact={obj.id}'
        )
        return format_html('<a href="{}">View Cards</a>', url)
    view_cards_link.short_description = 'Cards'
    view_cards_link.allow_tags = True
